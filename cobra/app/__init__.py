...
""".format(version=cobra.__version__)
...
# CLI
from cobra.app.cli import report, repair, install, scan, statistic, pull
...
# Front route
from cobra.app.controller.front import route, api

# Background route
from cobra.app.controller.backend import api, dashboard, index, language, project, rule, task, vulnerability, whitelist, framework, report, result
